...
const { validateRegister, validateLogin, validateForgotPassword, validateVerifyForgotPassword, validateRiwayatToken, validateVerifyChangePassword } = require("../middleware/validation.middleware");
